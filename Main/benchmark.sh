...
for impl in $implementations; do
    for size in $size_options; do
        ...
        echo -n "$size" >> measurement_times_$impl.csv
        echo -n "$size" >> measurement_bandwidth_$impl.csv
        for block_size in $block_sizes; do
            ...
            echo -n ", $time_setup_ms, $time_apply_ms, $time_total_ms" >> measurement_times_$impl.csv
            ...
            echo -n ", $bw_setup, $bw_apply, $bw_total" >> measurement_bandwidth_$impl.csv
        done
        echo "" >> measurement_times_$impl.csv
        echo "" >> measurement_bandwidth_$impl.csv
    done
done
